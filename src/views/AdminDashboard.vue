    ...
    <main class="flex-1 md:ml-64 p-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between h-32">
          ...
          <span class="text-3xl font-bold text-gray-900">{{ stats.total_members }}</span>
        </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between h-32">
          ...
          <span class="text-3xl font-bold text-gray-900">{{ stats.active_members }}</span>
        </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between h-32">
          ...
          <span class="text-3xl font-bold text-gray-900">{{ stats.inactive_members }}</span>
        </div>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-between h-32">
          ...
          <span class="text-3xl font-bold text-gray-900">{{ stats.covered_cities }}</span>
        </div>
